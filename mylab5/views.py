...
def plot_hyperplanes(request):
    ...
    <html>
        <body>
            ...
            <img src='data:image/png;base64,{base64.b64encode(buf_hard.getvalue()).decode()}'>
            <h2>Soft Margin SVM</h2>
            <img src='data:image/png;base64,{base64.b64encode(buf_soft.getvalue()).decode()}'>
        </body>
    </html>
    """
